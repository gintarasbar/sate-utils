...
public class FWMHCalculatorUTest {
    ...
    public void testO2Line() throws Exception {
        Spectra spectra = spectraReader.loadSpectra(file, "O2",6300.277, 6300.452);
//        Spectra spectra = spectraReader.loadSpectra(new File(file.toURI()).toString(), "O2",6300.10, 6300.50, 0, false, 0, 1);
    ...
    public void testScIILine() throws Exception {
        Spectra spectra = spectraReader.loadSpectra(file, "Sc2", 6300.577, 6300.777);
    ...
    public void testFeILine() throws Exception {
        Spectra spectra = spectraReader.loadSpectra(file, "Fe1", 6301.220, 6301.722);
        ...
        spectra = spectraReader.loadSpectra(file, "Fe1", 6302.307, 6302.660);
